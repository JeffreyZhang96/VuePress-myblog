...
记录差异
![记录差异](/assets/img/git-jlcy.png)

记录快照
![记录快照](/assets/img/git-glkz.png)
...
![三个区域](/assets/img/git-3-place.png)
...
![commit](/assets/img/git-commit.png)
...
![](/assets/img/git-rebease.png)

最后回到 master 分支，进行一次快进合并
![](/assets/img/git-mergep2.png)
